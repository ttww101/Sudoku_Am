...
-(void)loadData{
    ...
    [NetWorkTools GetUrl:@"http://v.juhe.cn/toutiao/index?type=tiyu&key=9c4dc4b86f616ef69d4dde1f4a146ce4" param:nil success:^(id responseObject) {
